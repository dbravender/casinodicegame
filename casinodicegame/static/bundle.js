...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  var GameView = React.createClass({displayName: "GameView",
	    ...
	    var Casino = React.createClass({displayName: "Casino",
	      render: function () {
	        if (!this.props.bills) return React.createElement("div", {className: "casino"});
	        var toPlay = [];
	        var i = -1;
	        var self = this;
	        ...
	        if (this.props.diceToPlay &&
	          ...
	          toPlay = React.createElement("div", {className: "to-play"}, 
	                     React.createElement("button", {onClick: play.bind(this, this.props.number)}, 
	                       React.createElement(Die, {color: this.props.currentPlayer.color, 
	                            number: this.props.diceToPlay[0]}), 
	                       React.createElement(Die, {color: "white", number: this.props.diceToPlay[1]})
	                     )
	                   );
	        } else {
	          toPlay = React.createElement("div", {className: "to-play"});
	        }
	        return React.createElement("div", {className: "casino"}, toPlay, components);
	      }
	    });

	    var Die = React.createClass({displayName: "Die",
	      render: function () {
	        var components = [];
	    ...
	    var Player = React.createClass({displayName: "Player",
	      render: function () {
	        return React.createElement("div", {className: "player " + this.props.player.color + " " + (this.props.currentPlayer ? (this.props.player.color == this.props.currentPlayer.color ? "current-player" : "") : "")}, 
	    ...
	    var io = __webpack_require__(148);
